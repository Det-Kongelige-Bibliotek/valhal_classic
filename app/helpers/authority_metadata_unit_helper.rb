...
module AuthorityMetadataUnitHelper
  ...
  # @param instance_metadata The metadata for the instance containing the image file.
  # @param portrait_metadata The metadata for the instance. If no work_type is defined, then it is set to 'PersonPortrait'
  ...
  def add_portrait(file, instance_metadata, portrait_metadata, agent_person)
    ...
    unless add_single_file_ins(file, instance_metadata, nil, portrait)
      return false
    end
  ...
  # @param instance_metadata The metadata for the instance containing the tei file.
  ...
  # @return false if operation was unsuccessful
  def add_person_description(tei_metadata, file, instance_metadata, agent_person_description_metadata, agent_person)
    ...
    unless add_single_tei_ins(tei_metadata, file, instance_metadata, portrait)
      return false
    end
